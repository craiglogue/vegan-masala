...
function matchesCollection(r: any, collection: string) {
  ...
  switch (collection) {
    ...
    case "gluten-free": {
      ...
      return diet.includes("gluten-free") || tags.includes("gluten-free") || txt.includes("gluten-free");
    }
    default:
      return true;
  }
...
export default async function RecipesPage({
  ...
  // ✅ searchParams is Promise in your setup
      ...
      <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {filtered.map((r: any) => {
          ...
          return (
            ...
            >
              {/* ✅ restore border color (no white frame) */}
